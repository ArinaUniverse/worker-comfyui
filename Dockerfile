...
RUN if [ "$MODEL_TYPE" = "flux1-dev-fp8" ]; then \
      ...
      \
      echo "Downloading LoRA Detail_Tweaker_Illustrious_BSY_V3.safetensors (CuteBlueEyed/Gemini_ILMix) - TESTING WITH TOKEN..."; \
      wget $WGET_OPTS --header="Authorization: Bearer ${HUGGINGFACE_ACCESS_TOKEN}" -O models/loras/Detail_Tweaker_Illustrious_BSY_V3.safetensors https://huggingface.co/CuteBlueEyed/Gemini_ILMix/resolve/main/Detail_Tweaker_Illustrious_BSY_V3.safetensors; \
      \
      echo "Downloading LoRA aidmaRealisticSkin-IL-v0.1.safetensors (CuteBlueEyed/Gemini_ILMix)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA aidmahyperrealism_IL.safetensors (CuteBlueEyed/Gemini_ILMix)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Catherine_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Hanmy_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Kaho_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Kitakana_GMIL_TAV102.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Kudan_GMIL_TAV102.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Li-Duoyuan_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Namiko_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Nanamin_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Nicole_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Nova_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Numi_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Ririka_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Vicky_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Yetta_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Yudan_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Yuina_GMIL_TAV103.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA NanJade_GMIL_TAV101.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Mirei_GMIL_TAV102.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Henna_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Jittaya_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Emily_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Nora_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Lomo_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Tessa_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Eun-Bi_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Jennifer_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA JenniferElf_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA KURA_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Mio_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Tenchan_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Anna_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
      ...
      echo "Downloading LoRA Fenny_GMIL_TAV1.safetensors (CuteBlueEyed/LoRAForGeminiX_IL)... (If previous token test worked, consider adding token here too)"; \
